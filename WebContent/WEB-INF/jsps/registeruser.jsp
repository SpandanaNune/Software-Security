...
function test()
{
	document.getElementById('ele').href='${pageContext.request.contextPath}/sendOTP?user='+document.getElementById('email').value;
...
​
		<table>
			...
			<tr>
				...
				<td><sf:input class="control form-control" onBlur="test()" path="email" id="email" name="email"
						type="text" /><br /> <sf:errors path="email" Class="error"></sf:errors></td>
			</tr>
			<tr>
				<td><br> <center>
			<!--  <a class="btn btn-primary btn-large" id="ele"
						 onclick="generate()">Send OTP [Arjun]</a> -->
