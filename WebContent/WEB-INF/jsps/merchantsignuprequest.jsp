...
<head>
  ...
  <title>Merchant Sign Up Requests</title>
</head>
    ...
    <table class="offers table table-hover">
      ...
      <c:forEach var="user" items="${user}">
        <tr>
          ...
          <td>
            <form method="post" action="${pageContext.request.contextPath}/acceptmerchantbtn">
          ...
          <td>
            <form method="post" action="${pageContext.request.contextPath}/declinemerchantbtn">
