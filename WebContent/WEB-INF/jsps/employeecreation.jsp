...
<body>
  ...
  <div class="container">
    ...
    action="${pageContext.request.contextPath}/employeecreation" commandName="user" htmlEscape="true">
      ...
      <table class="formtable">
        ...
        <tr>
          ...
          <td>
            <sf:input class="control form-control" path="SSN" name="SSN" type="password" />
            <br />
