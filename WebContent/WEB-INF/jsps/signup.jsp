		...
		<table class="formtable">
			...
			<tr>
				...
				<td><sf:input class="control" path="dob" name="dob"
						type="text" /><br /> <sf:errors path="dob" Class="error"></sf:errors></td>
			</tr>
			<tr>
				<td class="label">SSN:</td>
				<td><sf:input class="control" path="SSN" name="SSN"
						type="text" /><br /> <sf:errors path="SSN" Class="error"></sf:errors></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="label"></td>
				<td><input class="control" value="Verifyemail" type="submit" /></td>
			</tr>
			...
			<tr>
				...
				<td><sf:input class="control" path="Zip" name="Zip"
						type="text" /><br /> <sf:errors path="Zip" Class="error"></sf:errors></td>
			</tr>
			
			<tr>
				<td class="label"></td>
				<td><input class="control" value="Signup" type="submit" /></td>
			</tr>
		</table>
