...
function validateForm() {
   ...
   if (x1.match(alpha) && x1.length>=2 && x1.length<=45) {
    ...
    $("#matchpass1").addClass("error");
	   $("#matchpass1").text("name must be alphabetic and between 2 and 45 characters");
   ...
   $("#matchpass2").addClass("error");
	$("#matchpass2").text("invalid email id");
    ...
    $("#matchpass3").addClass("error");
	   $("#matchpass3").text("Phone number must be numeric without spaces/dashes");
    ...
    $("#matchpass4").addClass("error");
	   $("#matchpass4").text("TIN must be numeric without spaces/dashes");
   ...
   $("#matchpass5").addClass("error");
    ...
    $("#matchpass6").addClass("error");
	   $("#matchpass6").text("Address1 must be alphanumeric and between 2 and 45 characters");
    ...
    $("#matchpass7").addClass("error");
	   $("#matchpass7").text("Address2 must be alphanumeric and between 2 and 45 characters");
      ...
      //f=1;
	   ...
	   $("#matchpass8").text("");
		...
		$("#matchpass98").removeClass("error");
    }
   else{
    $("#matchpass8").addClass("error");
	   $("#matchpass8").text("City name must be alphabetic, no space and between 2 and 45 characters");
    ...
    $("#matchpass9").addClass("error");
	   $("#matchpass9").text("State name must be alphabetic, no space and between 2 and 45 characters");
    ...
    $("#matchpass10").addClass("error");
	   $("#matchpass10").text("Zipcode must be numeric without spaces/dashes");
			...
			<table>
				<tr>
					...
					<td><sf:input class="control form-control" path="username"
							name="username" type="text" /> <br /> <sf:errors
				...
				<tr>
					...
					<td><sf:input class="control form-control" path="SSN"
							name="SSN" type="password" /> <br /> <sf:errors path="SSN"
							Class="error"></sf:errors>
						<div id="matchpass4"></div></td>
				</tr>
				<tr>
					<td class="label">
						<h4 style="color: black">Date of Foundation (mm/dd/yyyy):</h4>
					</td>
