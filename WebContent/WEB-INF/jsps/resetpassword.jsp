...
<body>
	...
	<div class="container well">
		<center>
			...
			<sf:form id="details" method="post" action="${pageContext.request.contextPath}/resetpasswordbtn" commandName="users">
				...
				<table>
					<tr>
						<td>
							<sf:input class="control" path="username" name="username" type="hidden" />
							<br />
