...
<body>
  ...
  <div class="container well">
    <center>
      ...
      <sf:form id="details" method="post" action="${pageContext.request.contextPath}/activateuser" commandName="users">

        <table>
          <tr>
            <td>New Password:</td>
            <td>
              <sf:input id="password" class="form-control" path="password" name="password" type="text" />
              <br />
          ...
          <tr>
            ...
            <td>
              <sf:input class="form-control" path="q1" name="q1" type="text" />
              <br />
              <sf:errors path="q1" Class="error"></sf:errors>
            </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td>
              <sf:input class="form-control" path="q2" name="q2" type="text" />
              <br />
              <sf:errors path="q2" Class="error"></sf:errors>
            </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td>
              <sf:input class="form-control" path="q3" name="q3" type="text" />
              <br />
              <sf:errors path="q3" Class="error"></sf:errors>
            </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
